...
def save_syn(lines):
    ...
    checkpoint = torch.load(r'..\checkpointD2E\modelL1LNO_epoch_148600.ckpt')
    ...
    # filesynVS = r'D:\voiceset\dataset\testVSNO_wav'
    filesynI2E = r'D:\voiceset\dataset\spk_testdD2EL1LNO_wav'
