...
# ## ===== ===== ===== ===== ===== ===== ===== =====
#测试
def main_worker2(gpu, ngpus_per_node, args):
    args.gpu = gpu
    ...
    if args.eval == True:
        ...
        print('Test list', args.test_list)
        assert args.distributed == False
        devdir = r'E:\voxstructor实验数据\human\GWXujl-xAVM'
        trainer.voiceprint(devdir,)
...
def main():
    ...
    # if args.distributed:
    #     mp.spawn(main_worker, nprocs=0, args=(0, args))
    # else:
    #     main_worker(0, None, args)

    main_worker2(0, None, args)
